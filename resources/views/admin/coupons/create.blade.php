...
<div class="px-8 py-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Tạo mã giảm giá mới cho khách hàng</p>
        </div>
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST" class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" id="coupon_code" name="code" value="{{ old('code') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors uppercase" placeholder="VD: MAXBALL10K">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea name="description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="VD: Giảm 10k cho đơn từ 200k...">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <select name="discount_type" id="discount_type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="freeship" {{ old('discount_type') == 'freeship' ? 'selected' : '' }}>Miễn phí vận chuyển (FreeShip)</option>
                    </select>
                ...
                <div id="discount_value_container">
                    ...
                    <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" min="1000" step="1000" inputmode="numeric" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div id="max_discount_amount_container" style="display: none;">
                    ...
                    <input type="number" name="max_discount_amount" id="max_discount_amount" value="{{ old('max_discount_amount') }}" min="1000" step="1000" inputmode="numeric" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="VD: 100000">
                ...
                <div>
                    ...
                    <input type="number" name="min_order_value" value="{{ old('min_order_value') }}" min="1000" step="1000" inputmode="numeric" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Để trống nếu không yêu cầu">
                ...
                <div>
                    ...
                    <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" min="1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Để trống nếu không giới hạn số lượng">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="start_date" value="{{ old('start_date') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    <p class="text-xs text-gray-500 mt-1">Để trống nếu muốn áp dụng ngay lập tức.</p>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="expires_at" value="{{ old('expires_at') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    <p class="text-xs text-gray-500 mt-1">Để trống nếu không bao giờ hết hạn.</p>
                ...
                <div class="col-span-1 md:col-span-2 mt-4">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="status" value="1" {{ old('status', true) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        codeInput.addEventListener('input', function() {
            ...
            checkTimeout = setTimeout(() => {
                fetch(`{{ route('admin.coupons.check-code') }}?code=${encodeURIComponent(code)}`)
                    .then(res => res.json())
                    .then(data => {
                        if (data.exists) {
