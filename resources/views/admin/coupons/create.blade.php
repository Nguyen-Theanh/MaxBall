        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST" class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div id="discount_value_container">
                    ...
                    <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" min="0" step="0.01" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <input type="number" name="min_order_value" value="{{ old('min_order_value') }}" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Để trống nếu không yêu cầu">
