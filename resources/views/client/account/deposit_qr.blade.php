        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="md:flex">
                ...
                <div class="md:w-1/2 p-8 bg-gradient-to-br from-red-50 to-white flex flex-col items-center justify-center border-r">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2 text-center">Nạp Tiền Ví MaxBall</h2>
                ...
                <div class="md:w-1/2 p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="font-bold text-2xl text-gray-900 flex items-center justify-between">
                                <span id="amount">{{ number_format($transaction->amount, 0, ',', '.') }}đ</span>
                        ...
                        <div class="relative p-4 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                            ...
                            <div class="font-mono font-bold text-xl text-blue-600 flex items-center justify-between">
                                <span id="transfer-content">{{ $transaction->reference_code }}</span>
                    ...
                    <div class="mt-8 text-center">
                        <a href="{{ route('account.show') }}#wallet" class="text-sm text-gray-500 hover:text-gray-900 underline">Quay lại trang ví</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    const checkStatusUrl = '{{ route("client.wallet.check_status", ["reference_code" => ":code"]) }}'.replace(':code', refCode);
    const successUrl = '{{ route("account.show") }}#wallet';
            ...
            .then(data => {
                if (data.paid) {
                    ...
                    document.getElementById('payment-spinner').innerHTML = `
                        ...
                        <span class="text-green-600 font-bold text-lg">Nạp tiền thành công!</span>
                    `;
