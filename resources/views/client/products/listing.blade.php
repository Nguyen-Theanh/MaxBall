        ...
        <aside class="col-span-1">
            <div class="sticky top-[100px] bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                <h3 class="font-bold text-lg mb-5 text-[#10271d] flex items-center gap-2 uppercase tracking-wider">
                    <svg class="h-5 w-5 text-[#d92525]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <main class="col-span-1 lg:col-span-3">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                @forelse ($products as $product)
                    ...
                    @endphp
                    <div class="group bg-white rounded-2xl overflow-hidden shadow-[0_2px_10px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500 border border-gray-100 flex flex-col h-full">
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto pt-5 flex items-end justify-between">
                                ...
                                <button class="h-10 px-4 rounded-xl bg-[#f5f1e8] text-[#10271d] font-bold text-sm hover:bg-[#10271d] hover:text-white transition-all duration-300 active:scale-95">
                                    Mua
                                </button>
                            </div>
                        </div>
